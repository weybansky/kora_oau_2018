                ...
                <div class="col-lg-10 col-md-12">
                    ...
                    <div class="main-post">
                        ...
                        <div class="post-top-area">
                            ...
                            <h3 class="title text-center"><a href="#"><b>Edit Category</b></a></h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12">
                    ...
                    <div class="comment-form">
                        <form method="POST" action="{{ url('/category') }}/{{ $category->slug }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" aria-required="true" name="name" id="name" class="form-control"
                                        placeholder="Category Name" aria-invalid="true" required value="{{ $category->name }}">
                                </div><!-- col-sm-6 -->

                                <div class="col-sm-12">
                                    <textarea name="description" id="description" rows="2" class="text-area-messge form-control"
                                        placeholder="Category Description" aria-required="true" aria-invalid="false">{{ $category->description }}</textarea >
                                </div><!-- col-sm-12 -->
                                ...
                                <div class="col-sm-6" style="margin-bottom: 20px;">
                                    @if (isset($category->image))
                                        <img src="{{ asset('storage/posts') }}/{{ $category->image }}" alt="{{ $category->name }}">
                                    @endif
                                </div>
