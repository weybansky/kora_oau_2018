         ...
         <div class="row">
             ...
             <div class="col-lg-10 col-md-12">
                 ...
                 <div class="comment-form">
                     <form method="POST" action="{{ url('ask-for-help') }}" enctype="multipart/form-data">
                         @csrf
                         <div class="row">

                             <div class="col-sm-12">
                                 <input type="text" aria-required="true" name="title" id="title" class="form-control"
                                     placeholder="Title" aria-invalid="true" required value="{{ old('title') }}">
                             </div><!-- col-sm-6 -->
                             ...
                             <div class="col-sm-6">
                                <input type="number" aria-required="true" name="target" id="target" class="form-control"
                                     placeholder="Target : #500" aria-invalid="true" required value="{{ old('target') }}" min="500">
                             ...
                             <div class="col-sm-12">
                                 <textarea name="content" id="content" rows="2" class="text-area-messge form-control"
                                     placeholder="Content" aria-required="true" aria-invalid="false" required>{{ old('content') }}</textarea>
                             </div><!-- col-sm-12 -->
                             ...
                             <div class="col-sm-12">
                                 <button class="submit-btn" type="submit" id="form-submit"><b>Save</b></button>
                             </div><!-- col-sm-12 -->
